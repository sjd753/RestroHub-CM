package com.ogma.restrohub.application;
...
public class AppSettings {
    ...
    public AppSettings(Context context) {
        ...
        __tables = sharedPreferences.getString(Constant.APP_SETTINGS_KEY.APP_RESTAURANT_TABLES.name(), __tables);
...
//        this.__uImage = __uImage;
    ...
    public void setRestaurantTables(String __tables) {
        this.__tables = __tables;

        Editor editor = sharedPreferences.edit();
        editor.putString(Constant.APP_SETTINGS_KEY.APP_RESTAURANT_TABLES.name(), __tables);
        editor.commit();
        editor = null;
    }
